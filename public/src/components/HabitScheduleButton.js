...
function HabitScheduleButton({ habit, onChange }) {
  ...
  return (
    <div className="relative" ref={ref}>
      <button onClick={() => setOpen(v => !v)} className="btn-soft">Schedule</button>
      {open && (
        <div className="absolute top-full right-0 z-50 mt-2 w-72 rounded-xl border border-slate-200/70 dark:border-slate-700/60 bg-white/95 dark:bg-slate-800/95 backdrop-blur p-3 text-sm shadow-xl shadow-emerald-900/10">
